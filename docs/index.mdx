---
title: "概述"
description: "一个简单、开放的格式，用于赋予 AI 智能体新的能力和专业知识。"
---
...
- [什么是技能？](what-are-skills) - 了解技能的工作原理及其重要性
- [规范](specification) - SKILL.md 文件的完整格式规范
- [添加技能支持](client-implementation/adding-skills-support) - 为你的智能体或工具添加技能支持
